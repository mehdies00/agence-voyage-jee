...
<section class="login">
    ...
    <form action="#" method="post" class="login__form" id="loginCard">
        ...
        <div class="login__group">
            <input type="email" id="email" class="login__input" placeholder=" ">
            <label for="email" class="login__label">Email</label>
            <span class="login__error-message">Email invalide</span>
        </div>

        <div class="login__group">
            <input type="password" id="password" class="login__input" placeholder=" ">
    ...
    <form action="#" method="post" class="login__form hidden" id="registerCard">
        <h2 class="login__heading">Create Account</h2>

        <div class="login__group">
            <input type="text" id="reg-username" class="login__input" placeholder=" ">
            <label for="reg-username" class="login__label">Username</label>
            <span class="login__error-message">Nom d'utilisateur requis</span>
        </div>

        <div class="login__group">
            <input type="email" id="reg-email" class="login__input" placeholder=" ">
            <label for="reg-email" class="login__label">Email</label>
            <span class="login__error-message">Email invalide</span>
        </div>

        <div class="login__group">
            <input type="password" id="reg-password" class="login__input" placeholder=" ">
            <label for="reg-password" class="login__label">Password</label>
            <span class="login__error-message">Mot de passe requis</span>
        </div>

        <div class="login__group">
            <input type="password" id="reg-password-confirm" class="login__input" placeholder=" ">
        ...
        <div class="login__switch">
            ...
            <strong id="showLogin">Log in</strong>
        </div>
    </form>
